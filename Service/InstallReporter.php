<?php
/**
 * Standalone install + heartbeat reporter for Panth_Hreflang.
 *
...
namespace Panth\Hreflang\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_Hreflang';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-hreflang';
